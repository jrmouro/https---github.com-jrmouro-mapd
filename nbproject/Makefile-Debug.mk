...
${OBJECTDIR}/_agent_designed.o: _agent_designed.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_agent_designed.o _agent_designed.cpp
...
${OBJECTDIR}/_agent_designed_nomain.o: ${OBJECTDIR}/_agent_designed.o _agent_designed.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_agent_designed_nomain.o _agent_designed.cpp;\
	else  \
