...
${OBJECTDIR}/BinarySite.o: BinarySite.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinarySite.o BinarySite.cpp
...
${OBJECTDIR}/BinarySite_nomain.o: ${OBJECTDIR}/BinarySite.o BinarySite.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinarySite_nomain.o BinarySite.cpp;\
	else  \
