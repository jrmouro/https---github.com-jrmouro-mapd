...
${OBJECTDIR}/_ga_estimative_of_path.o: _ga_estimative_of_path.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ga_estimative_of_path.o _ga_estimative_of_path.cpp
...
${TESTDIR}/tests/newsimpletest5.o: tests/newsimpletest5.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newsimpletest5.o tests/newsimpletest5.cpp
...
${OBJECTDIR}/_ga_estimative_of_path_nomain.o: ${OBJECTDIR}/_ga_estimative_of_path.o _ga_estimative_of_path.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ga_estimative_of_path_nomain.o _ga_estimative_of_path.cpp;\
	else  \
