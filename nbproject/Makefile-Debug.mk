...
${OBJECTDIR}/_backwardTaskDeliveryEndpointAlgorithm.o: _backwardTaskDeliveryEndpointAlgorithm.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_backwardTaskDeliveryEndpointAlgorithm.o _backwardTaskDeliveryEndpointAlgorithm.cpp
...
${OBJECTDIR}/_backwardTaskDeliveryEndpointAlgorithm_nomain.o: ${OBJECTDIR}/_backwardTaskDeliveryEndpointAlgorithm.o _backwardTaskDeliveryEndpointAlgorithm.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_backwardTaskDeliveryEndpointAlgorithm_nomain.o _backwardTaskDeliveryEndpointAlgorithm.cpp;\
	else  \
