...
${OBJECTDIR}/Site.o: Site.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Site.o Site.cpp

${OBJECTDIR}/SiteMap.o: SiteMap.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SiteMap.o SiteMap.cpp
...
${OBJECTDIR}/_agent_free.o: _agent_free.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_agent_free.o _agent_free.cpp

${OBJECTDIR}/_agent_occupied.o: _agent_occupied.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_agent_occupied.o _agent_occupied.cpp
...
${OBJECTDIR}/Site_nomain.o: ${OBJECTDIR}/Site.o Site.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Site_nomain.o Site.cpp;\
	else  \
...
${OBJECTDIR}/SiteMap_nomain.o: ${OBJECTDIR}/SiteMap.o SiteMap.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SiteMap_nomain.o SiteMap.cpp;\
	else  \
...
${OBJECTDIR}/_agent_free_nomain.o: ${OBJECTDIR}/_agent_free.o _agent_free.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_agent_free_nomain.o _agent_free.cpp;\
	else  \
...
${OBJECTDIR}/_agent_occupied_nomain.o: ${OBJECTDIR}/_agent_occupied.o _agent_occupied.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_agent_occupied_nomain.o _agent_occupied.cpp;\
	else  \
