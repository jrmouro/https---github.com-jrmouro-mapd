...
${OBJECTDIR}/_updateChargingEndpointToAgentAlgorithm.o: _updateChargingEndpointToAgentAlgorithm.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_updateChargingEndpointToAgentAlgorithm.o _updateChargingEndpointToAgentAlgorithm.cpp

${OBJECTDIR}/_updateRestEndpointToAgentAlgorithm.o: _updateRestEndpointToAgentAlgorithm.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_updateRestEndpointToAgentAlgorithm.o _updateRestEndpointToAgentAlgorithm.cpp
...
${OBJECTDIR}/_updateTaskToAgentThresholdAlgorithm.o: _updateTaskToAgentThresholdAlgorithm.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_updateTaskToAgentThresholdAlgorithm.o _updateTaskToAgentThresholdAlgorithm.cpp

${OBJECTDIR}/_updateTrivialPathToAgent.o: _updateTrivialPathToAgent.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_updateTrivialPathToAgent.o _updateTrivialPathToAgent.cpp
...
${OBJECTDIR}/_updateChargingEndpointToAgentAlgorithm_nomain.o: ${OBJECTDIR}/_updateChargingEndpointToAgentAlgorithm.o _updateChargingEndpointToAgentAlgorithm.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_updateChargingEndpointToAgentAlgorithm_nomain.o _updateChargingEndpointToAgentAlgorithm.cpp;\
	else  \
...
${OBJECTDIR}/_updateRestEndpointToAgentAlgorithm_nomain.o: ${OBJECTDIR}/_updateRestEndpointToAgentAlgorithm.o _updateRestEndpointToAgentAlgorithm.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_updateRestEndpointToAgentAlgorithm_nomain.o _updateRestEndpointToAgentAlgorithm.cpp;\
	else  \
...
${OBJECTDIR}/_updateTaskToAgentThresholdAlgorithm_nomain.o: ${OBJECTDIR}/_updateTaskToAgentThresholdAlgorithm.o _updateTaskToAgentThresholdAlgorithm.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_updateTaskToAgentThresholdAlgorithm_nomain.o _updateTaskToAgentThresholdAlgorithm.cpp;\
	else  \
...
${OBJECTDIR}/_updateTrivialPathToAgent_nomain.o: ${OBJECTDIR}/_updateTrivialPathToAgent.o _updateTrivialPathToAgent.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_updateTrivialPathToAgent_nomain.o _updateTrivialPathToAgent.cpp;\
	else  \
