...
OBJECTFILES= \
	...
	${OBJECTDIR}/_ga_estimative_of_path.o \
...
${OBJECTDIR}/_ga_estimate_of_path_task_endpoint.o: _ga_estimate_of_path_task_endpoint.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ga_estimate_of_path_task_endpoint.o _ga_estimate_of_path_task_endpoint.cpp

${OBJECTDIR}/_ga_estimative_of_path.o: _ga_estimative_of_path.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ga_estimative_of_path.o _ga_estimative_of_path.cpp
...
${OBJECTDIR}/_r_ga_token.o: _r_ga_token.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_r_ga_token.o _r_ga_token.cpp

${OBJECTDIR}/_r_stepMap.o: _r_stepMap.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_r_stepMap.o _r_stepMap.cpp
...
${TESTDIR}/_ext/7e63588e/newsimpletest4.o: ../../../../../NetBeansProjects/Map/tests/newsimpletest4.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/7e63588e/newsimpletest4.o ../../../../../NetBeansProjects/Map/tests/newsimpletest4.cpp
...
${TESTDIR}/tests/newsimpletest5.o: tests/newsimpletest5.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. `pkg-config --cflags sfml-all` -std=c++14  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newsimpletest5.o tests/newsimpletest5.cpp
...
${OBJECTDIR}/_ga_estimate_of_path_task_endpoint_nomain.o: ${OBJECTDIR}/_ga_estimate_of_path_task_endpoint.o _ga_estimate_of_path_task_endpoint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ga_estimate_of_path_task_endpoint_nomain.o _ga_estimate_of_path_task_endpoint.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/_ga_estimate_of_path_task_endpoint.o ${OBJECTDIR}/_ga_estimate_of_path_task_endpoint_nomain.o;\
	fi

${OBJECTDIR}/_ga_estimative_of_path_nomain.o: ${OBJECTDIR}/_ga_estimative_of_path.o _ga_estimative_of_path.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/_ga_estimative_of_path.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ga_estimative_of_path_nomain.o _ga_estimative_of_path.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/_ga_estimative_of_path.o ${OBJECTDIR}/_ga_estimative_of_path_nomain.o;\
	fi
...
${OBJECTDIR}/_r_ga_token_nomain.o: ${OBJECTDIR}/_r_ga_token.o _r_ga_token.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_r_ga_token_nomain.o _r_ga_token.cpp;\
	else  \
...
${OBJECTDIR}/_r_stepMap_nomain.o: ${OBJECTDIR}/_r_stepMap.o _r_stepMap.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g `pkg-config --cflags sfml-all` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_r_stepMap_nomain.o _r_stepMap.cpp;\
	else  \
