...
_agent::_agent(int _id, const _stepSite& currentSite, int amount_energy) : 
_id(_id), _currentPath(currentSite), _state(_agent_parked::getInstance()), energy(amount_energy) { }
...
//    bool flag = system.getToken().selectNewTaskPathToAgent(*this, newTask, path, pickupStep);
//    
//    if(flag){
//        
