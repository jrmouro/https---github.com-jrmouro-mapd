...
df4 = df2.groupby(["Frenq.","Token"]).agg({'Makespan':np.median, 'Energia':np.median}).round(3).reset_index()

df5 = df4.pivot_table(["Makespan","Energia"], ["Frenq."], 'Token')

print(df5)

df5.to_csv('./Monografia/small/small_resumo_freq.csv',';')